...
if (isset($_GET['mail'])) {
   ...
   if($getActionURI ==="request") {
      ...
      $smtp_host        = 'dominio.com';   // Dominio sin www
      $smtp_port        = 465;   // No cambies el número de puerto
      $smtp_username    = 'demo@mail.com';   // Cuenta de correo
      ...
      try {
         ...
         $mail->addAddress("correo@mail.com");  // Correo al cual llegarán los mensajes del formulario puede ser gmail o cualquier otro.
